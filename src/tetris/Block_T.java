...
public class Block_T extends Figure{
    
    public Block_T(int firstColumn,int color) {
    ...
    protected boolean spin() {
        ...
        if(rotation%4==0){
            int Tl0=getLine(0)+1,Tc0=getColumn(0)+1;
            int Tl1=Tl0-1,Tc1=Tc0-1;
            int Tl2=Tl0,Tc2=Tc0-1;
            int Tl3=Tl0+1,Tc3=Tc0-1;
    ...
    protected boolean spin2(int line, int column) {
        ...
        if(rotation%4==0){
            int Tl0=line+getLine(0)+1,Tc0=column+getColumn(0)+1;
            int Tl1=Tl0-1,Tc1=Tc0-1;
            int Tl2=Tl0,Tc2=Tc0-1;
            int Tl3=Tl0+1,Tc3=Tc0-1;
